...
namespace LsrCoop.Server
{
    internal class EventRouter
    {
        ...
        public static readonly int CharacterCreatedEventHash = CustomEvents.Hash("lsrcoop.character.created");
        ...
        public static readonly int LocationDiscoverySnapshotCommittedEventHash = CustomEvents.Hash("lsrcoop.locationDiscovery.snapshot.committed");
        public static readonly int LastPositionCommittedEventHash = CustomEvents.Hash("lsrcoop.profile.lastPosition.committed");
